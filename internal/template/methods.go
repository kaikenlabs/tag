...
func createCustomStringMethods() *exec.MethodSet[string] {
	return exec.NewMethodSet(map[string]exec.Method[string]{
		...
		"capitalize": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).Capitalize(), nil
		},
		"capwords": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).CapWords(), nil
		},
		"casefold": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).Casefold(), nil
		},
		"center": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				width    int
				fillchar string
			)
		...
		"count": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				sub   string
				start int
				end   int
		...
		"endswith": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				suffix string
				start  int
				end    int
		...
		"find": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				sub   string
				start int
				end   int
		...
		"format": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
		...
		"format_map": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			args := make([]any, 0, len(arguments.Args))
			for _, arg := range arguments.Args {
				args = append(args, arg.Interface())
			}
		...
		"isalnum": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsAlnum(), nil
		},
		"isalpha": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsAlpha(), nil
		},
		"isascii": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsASCII(), nil
		},
		"isdecimal": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsDecimal(), nil
		},
		"isdigit": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsDigit(), nil
		},
		"islower": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsLower(), nil
		},
		"isnumeric": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsNumeric(), nil
		},
		"isprintable": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsPrintable(), nil
		},
		"isspace": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsSpace(), nil
		},
		"istitle": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsTitle(), nil
		},
		"isupper": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).IsUpper(), nil
		},
		"join": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var strs []string
			if err := arguments.Take(
		...
		"ljust": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				width    int
				fillchar string
			)
		...
		"lower": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).Lower(), nil
		},
		"lstrip": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var cutset string
			if err := arguments.Take(
		...
		"partition": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var sep string
			if err := arguments.Take(
		...
		"removeprefix": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var prefix string
			if err := arguments.Take(
		...
		"removesuffix": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var suffix string
			if err := arguments.Take(
				exec.PositionalArgument("suffix", nil, exec.StringArgument(&suffix)),
			); err != nil {
		...
		"replace": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				old    string
				newStr string
				count  int
		...
		"rfind": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				sub   string
				start int
				end   int
		...
		"rjust": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				width    int
				fillchar string
			)
		...
		"rpartition": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var sep string
			if err := arguments.Take(
				exec.PositionalArgument("sep", exec.AsValue(' '), exec.StringArgument(&sep)),
			); err != nil {
		...
		"rsplit": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				sep      string
				maxsplit int
			)
		...
		"rstrip": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var cutset string
			if err := arguments.Take(
				exec.PositionalArgument("cutset", exec.AsValue(' '), exec.StringArgument(&cutset)),
			); err != nil {
		...
		"split": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				sep      string
				maxsplit int
			)
		...
		"splitlines": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var keepends bool
			if err := arguments.Take(
		...
		"startswith": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var (
				prefix   string
				prefixes []string
				start    int
		...
		"strip": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var cutset string
			if err := arguments.Take(
				exec.PositionalArgument("cutset", exec.AsValue(""), exec.StringArgument(&cutset)),
			); err != nil {
		...
		"swapcase": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).SwapCase(), nil
		},
		"title": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).Title(), nil
		},
		"upper": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			if err := arguments.Take(); err != nil {
				return nil, exec.ErrInvalidCall(err)
			}
			return pystring.PyString(self).Upper(), nil
		},
		"zfill": func(self string, _ *exec.Value, arguments *exec.VarArgs) (interface{}, error) {
			var width int
			if err := arguments.Take(
				exec.PositionalArgument("width", nil, exec.IntArgument(&width)),
			); err != nil {
