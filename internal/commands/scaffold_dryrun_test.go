...
// forwards opts.DryRun into that helper correctly — that wiring is guarded
// only by TestIT_Scaffold_DryRun_LeavesWorkDirUntouched in
// internal/integration, per verifyTemplateLock's own doc comment.
